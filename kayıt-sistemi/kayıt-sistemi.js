...
exports.run = async (client, message, args) => {
   ...
   if(args[0] === "yetkili-ayarla") {
        ...
        db.set(`CwlKayıtYetki${message.guild.id}`, rol.id)
    ...
    if(args[0] === "yetkili-sıfırla") {
        db.delete(`CwlKayıtYetki${message.guild.id}`, kayıtsızrol.id)
    ...
    if(args[0] === "kayıtsız-ayarla") {
        ...
        db.set(`CwlKayıtsızRol${message.guild.id}`, kayıtsızrol.id)
        let kayıtsızayarla = new Discord.MessageEmbed()
    ...
    if(args[0] === "kayıtsız-sıfırla") {
        db.delete(`CwlKayıtsızRol${message.guild.id}`, kayıtsızrol.id)
    ...
    if(args[0] === "kayıtlı-ayarla") {
        ...
        db.set(`CwlKayıtlıRol${message.guild.id}`, kayıtlırol.id)
    ...
    if(args[0] === "kayıtlı-sıfırla") {
        db.delete(`CwlKayıtlıRol${message.guild.id}`, kayıtlırol.id)
